...
public class ExtentReportDemo {
	...
	public void loginTest() throws IOException {
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter("./test-output/ExtentReports/learn_automation1.html");
		...
		logger2.fail("Failed because of some issues",
				MediaEntityBuilder.createScreenCaptureFromPath("/Users/mayan/Desktop/logo.jpg").build());
